...
class Test:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.image_open = pygame.image.load('Typing-Speed-Test\Front.png')
        self.image_open = pygame.transform.scale(self.image_open, (self.w,self.h))


        self.bg = pygame.image.load('Typing-Speed-Test\BackPics.jpg')
    ...
    def get_challenge(self):
        return random.choice(open('Typing-Speed-Test\sentence.txt').read().split('\n'))
    ...
    def results_show(self, screen):
        if(not self.end):
            ...
            # Draw Icon image
            self.time_img = pygame.image.load('Typing-Speed-Test\Reset-button.jpg')
            self.time_img = pygame.transform.scale(self.time_img, (150,50))
